...
public class ItemDaoImpl implements ItemDao {
    ...
    public ItemDto updateItem(long userId, long itemId, ItemDto itemDto) {
        try {
            ...
            if(isHasNewName){item.setName(itemDto.getName());}
            if(isHasNewDescription){item.setDescription(itemDto.getDescription());}
            if(isAvailable){item.setAvailable(itemDto.getAvailable());}
